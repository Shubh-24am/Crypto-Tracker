      ...
      <div>
        <main className="text-gray-900">
          <section className="pt-16 sm:pt-24 lg:pt-40">
            <div className="container mx-auto px-6 lg:flex lg:items-center lg:gap-10">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                  Main title of your landing page
                </h1>
                <p className="text-lg sm:text-xl lg:text-2xl mt-6 font-light">
                ...
                <p className="mt-8 md:mt-12">
                  <button
                    ...
                    className="w-full sm:w-auto py-4 px-12 bg-teal-500 hover:bg-teal-600 rounded text-white"
                  >
                    Get Started
                  </button>
                </p>
